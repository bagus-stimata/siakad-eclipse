...
@Entity
@Table(name = "m_dosen")
public class MDosen implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @Column(name = "id_dosen", nullable = false, length = 10)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MDosen)) {
            return false;
        }
        MDosen other = (MDosen) object;
    ...
    public String toString() {
        return "org.config.spring.hibernate.model.MDosen[ idDosen=" + idDosen + " ]";
    }
